...
namespace Nexus.Editor
{
    public static class NexusCodeGenerator
    {
        ...
        public static void GenerateBinder()
        {
            ...
            {
                Debug.LogWarning("[Nexus CodeGen] Code generation aborted: Discovery output is empty or no inject types found.");
                return;
            }
            ...
            if (File.Exists(destBinderFile))
            {
                ...
                {
                    Debug.LogWarning($"[Nexus CodeGen] Overwrite blocked: The file at '{destBinderFile}' does not contain the <auto-generated> tag. It may have been manually modified by the user.");
                    return;
                }
            }
