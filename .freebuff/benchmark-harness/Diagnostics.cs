    ...
    public static class Diagnostics
    {
        ...
        private static int MeasureFireWithPrefilledPool()
        {
            ...
            try
            {
                ...
                long perDispatch = allocated / 5000;
                long createdDelta = stats2.Count > 0 ? stats2[0].TotalCreated - (stats1.Count > 0 ? stats1[0].TotalCreated : 0) : -1;
                ...
                Console.WriteLine($"[Nexus Benchmark]   available {stats0[0].Available}->{stats1[0].Available}->{stats2[0].Available}, createdDelta during fire={createdDelta}");
                return 0;
            }
            finally
            {
