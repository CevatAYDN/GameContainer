// Standalone benchmark harness for the Nexus runtime — replicates the assertions in
// Nexus/Packages/com.nexus.core/Tests/Runtime/PerformanceTests.cs so the same numbers
// can be produced on plain .NET when the Unity editor (6000.5) is unavailable.
//
    ...
    public static class Program
    {
        ...
        public static int Main(string[] args)
        {
            ...
            Console.WriteLine(_failures == 0
                ...
                : $"[Nexus Benchmark] {_failures} BENCHMARK(S) FAILED ✗");
